  ...
  <el-row class="warp">
    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          ...
          <el-form-item label="在线状态">
            <el-select v-model="state" placeholder="请选择在线状态" @change="search()" clearable>
              <el-option
      ...
      <el-table :data="vip" highlight-current-row @selection-change="selsChange"
        ...
        <el-table-column prop="nickname" label="用户名称" width="auto"></el-table-column>
        <el-table-column prop="gold" label="玉石剩余量" width="auto" sortable="custom"></el-table-column>
        <el-table-column prop="score" label="礼券剩余量" width="auto" sortable="custom"></el-table-column>
        <el-table-column prop="createTime" label="注册时间" width="auto" sortable="custom"></el-table-column>
        <el-table-column prop="vip" label="是否会员" width="auto" sortable="custom"></el-table-column>
        <el-table-column prop="vipEndTime" label="到期时间" width="auto" sortable="custom"></el-table-column>
    ...
    methods: {
      ...
      jade(memberId,page){
        axios({
          ...
          this.total1 = res.data.data.pageCount;//总页数
      ...
      handleSearch(goldSort,scoreSort,createTimeSort,vipSort,vipEndTimeSort,vipLevelSort,vipScoreSort,onlineStateSort,verifyUserSort){
        ...
        axios({//根据会员昵称查询
          ...
          if(res.data.data.memberList.pageCount < res.data.data.memberList.pageNum){
            this.total = res.data.data.memberList.pageNum
          }
