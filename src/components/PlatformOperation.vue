  ...
  <el-row class="warp">
    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-table :data="items" highlight-current-row @selection-change="selsChange"
        ...
        <el-table-column prop="newMember" label="新增注册量" width="auto"></el-table-column>
        <el-table-column prop="currentMember" label="当日会员人数" width="auto"></el-table-column>
        <el-table-column prop="cost" label="消费金额（元）" width="auto"></el-table-column>
        <el-table-column prop="gameNum" label="游戏总局数" width="auto"></el-table-column>
        <el-table-column prop="loginMember" label="独立玩家" width="auto"></el-table-column>
        <el-table-column prop="remainSecond" label="次日留存" width="auto"></el-table-column>
        <el-table-column prop="remainThird" label="三日留存" width="auto"></el-table-column>
        <el-table-column prop="remainSeventh" label="七日留存" width="auto"></el-table-column>
        <el-table-column prop="remainMonth" label="30日以外留存" width="auto"></el-table-column>
      </el-table>
      <!--工具条-->
